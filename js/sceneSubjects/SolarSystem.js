...
export function SolarSystem (scene, controller, planets = [], sun = null) {
	...
	if (sun == null) sun = { name: "sun", size: 20, scene: scene, orbit: solarSystem, astrionomicalBodies: astrionomicalBodies, loader: loader, texturePath: "assets/textures/sun.jpg", illuminated: true };
	sun["orbit"] = solarSystem;
	sun["astrionomicalBodies"] = astrionomicalBodies;
	sun["loader"] = loader;
	...
	planets.forEach(planet => {
		...
		var planetMesh = createPlanet(planet.name, planet.size, planet.distanceX, scene, planetOrbit, astrionomicalBodies, loader, planet.selfTilt, planet.texture, planet.illuminated);
...
function createPlanet (name, size, distanceX, scene, orbit, astrionomicalBodies, loader, selfTilt = 90, texturePath = null, illuminated = false) {
